...
app.get('/massnahmen-katalog', function (req, res) {
  var queryString = "SELECT res_kategorie_tb.res_kategorie_id, res_kategorie_tb.res_kategorie_name, massnahmen_tb.massnahmen_name, massnahmen_tb.massnahmen_beschreibung FROM res_kategorie_tb, massnahmen_tb ORDER BY ressourcen_tb.ressourcen_kategorie";
